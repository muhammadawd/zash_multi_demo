    ...
    var vc3dEye = function (selectorName, params) {
        ...
        function assignOperations() {
            selector.mousedown(function (target) {
                var isMoving = true;
                var currentX = target.pageX - this.offsetLeft;
            ...
            selector.bind("touchmove", function (target) {
                ...
                if (isMoving == true)
                    ...
                    var currentX = actualTouch.pageX - this.offsetLeft
            })
        }
        ...
        function loadAppropriateImage(newX) {
            ...
            if (currentX - newX > 25) {
                ...
                var currentX = newX;
                var currentImage = --currentImage < 1 ? totalImages : currentImage;
                ...
                console.log("currentX-newX=" + (currentX - newX));
                var currentX = newX;
                var currentImage = ++currentImage > totalImages ? 1 : currentImage;
                console.log("currentImage=" + currentImage)
                selector.css("background-image", "url(" + imagePath + currentImage + "." + imageExtension + ")");
            }
