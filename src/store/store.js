    ...
    actions: {
        ...
        syncDeleteCart({state, dispatch}, toDeleteInfo) {
            ...
            if (auth) {
                ...
                apiServiesRoutes.API().post(apiServiesRoutes.BASE_URL + apiServiesRoutes.DELETE_CART, {
        ...
        syncCart({state, dispatch}) {
            ...
            if (auth) {
                ...
                apiServiesRoutes.API().post(apiServiesRoutes.BASE_URL + apiServiesRoutes.SYNC_CART, {
            ...
            // CHECK_FOR_PROMOTION
            apiServiesRoutes.API().post(apiServiesRoutes.BASE_URL + apiServiesRoutes.CHECK_FOR_PROMOTION, {
        ...
        syncGetCart({state, dispatch}) {
            ...
            if (auth) {
                let token = auth.token;
                // get cart data
                apiServiesRoutes.API().get(apiServiesRoutes.BASE_URL + apiServiesRoutes.GET_ALL_CART, {
                    headers: {Authorization: "Bearer " + token}
                }).then((response) => {
                    let status = response.data.status;
                    let data = response.data.data;
