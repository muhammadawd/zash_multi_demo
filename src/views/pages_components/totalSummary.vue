            ...
            <div class="row">
                <div class="col-12 mt-4" style="border-bottom: 1px solid #ccc;cursor: pointer"
                        ...
                        <li style="overflow: hidden;cursor: pointer">
                            <div class="float-right">
                                <i class="fa fa-arrow-left"
                                   style="position:relative;top: 7px;margin: 4px;color: #fff;"></i>
                            </div>
                    ...
                    <ul class="direction" style="color: #999;" v-if="products_summary.length">
                        <li v-for="(item , key) in products_summary">{{item.product_translation.title}}</li>
                        <!--<li>{{current_address_data.full_address}}</li>-->
                    </ul>
                </div>
                <div class="col-12 mt-4" style="border-bottom: 1px solid #ccc;cursor: pointer"
                    ...
                    <ul class="p-0 list-unstyled">
                        <li style="overflow: hidden;cursor: pointer">
                            <div class="float-right">
                                <i class="fa fa-arrow-left"
                                   style="position:relative;top: 7px;margin: 5px;color: #fff;"></i>
                            </div>
                            <div class="font-weight-bold" style="background: #2dce89;color: #fff;padding: 7px;">
                                {{this.$ml.get('add_address')}}
                            </div>
                        </li>
                        <li class="text-danger" id="address_error_tab"></li>
                    </ul>
                    <ul class="direction" style="color: #999;" v-if="current_address_data">
                        <li>{{current_address_data.phone}}</li>
                        <li>{{current_address_data.full_address}}</li>
                    </ul>
                </div>
                <div class="col-12 mt-4" style="border-bottom: 1px solid #ccc;cursor: pointer"
                ...
                <div class="col-md-12">
                    <button class="btn btn-success mt-4 btn-block" @click="submitCheckout()"
            ...
            submitCheckout() {
                ...
                this.$apiServiesRoutes.API().post(this.$apiServiesRoutes.BASE_URL + this.$apiServiesRoutes.CREATE_SALE, request_date, {
                    ...
                    if (data.validation_errors.address_id) {
                        ...
                        $('#address_error_tab').text(data.validation_errors.address_id[0]);
                        // setTimeout(() => {
                        //     $('#address_error_tab').text('')
                        // }, 2000)
